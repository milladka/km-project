{
    ...
    class Item {
        constructor(el) {
            ...
            this.renderedStyles = {
                ...
                innerTranslationY: {
                    ...
                    maxValue: this.DOM?.image ? parseInt(getComputedStyle(this.DOM.image).getPropertyValue('--overflow'), 10) : '',
        ...
        layout() {
            ...
            this.DOM?.image ? this.DOM.image.style.transform = `translate3d(0,${this.renderedStyles.innerTranslationY.previous}px,0)` : '';
        }
    }
